...
async def start_uploading(data):
    ...
    try:
        if data["480p"]=='0':
            ...
            filed = filed.replace("2nd Season", "Season 2")
            filed = filed.replace("3rd Season", "Season 3")
            filed = filed.replace("4th Season", "Season 4")
            filed = filed.replace("5th Season", "Season 5")
            filed = filed.replace("6th Season", "Season 6")
            filed = filed.replace("7th Season", "Season 7")
